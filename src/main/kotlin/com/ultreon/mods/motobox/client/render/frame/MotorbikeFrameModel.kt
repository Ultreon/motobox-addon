...
import com.ultreon.mods.motobox.util.motoboxId
 ...
 */
class MotorbikeFrameModel(root: ModelPart) : EntityModel<AutomobileEntity>(Function(RenderLayer::getEntityTranslucent)) {
    ...
    constructor(root: EntityRendererFactory.Context) : this(root.getPart(modelLayer))
